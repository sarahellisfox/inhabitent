...
function red_starter_scripts() {
	wp_enqueue_style( 'red-starter-fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.min.css' );

	wp_enqueue_style( 'red-starter-style', get_stylesheet_uri() );
	wp_enqueue_script( 'jquery'  );

	wp_enqueue_script( 'inhabitent-search-js', get_template_directory_uri() . '/build/js/search.min.js', array(), '20151215', true );
